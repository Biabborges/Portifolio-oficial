    ...
    <section id="formacao" className="py-20 px-6 bg-gradient-to-b from-white to-neutral/30">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-bold text-neutral-dark mb-4 font-heading">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8 justify-center">
              ...
              <h3 className="text-3xl font-bold text-neutral-dark font-heading">
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-neutral-dark mb-1 group-hover:text-primary transition-colors">
                        {formacao.titulo}
                      </h4>
                    ...
                    <span className="bg-accent/10 text-accent px-3 py-1 rounded-full text-sm font-medium whitespace-nowrap ml-4">
                      {formacao.tipo}
                    </span>
                  </div>
          ...
          <div>
            ...
            {/* Grid de tecnologias minimalista */}
            <div className="space-y-6">
            ...
            <div className="mt-8 bg-white rounded-2xl p-6 border-2 border-primary/20">
              <div className="grid grid-cols-3 gap-4 text-center">
                <div className="relative">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-12 h-[2px] bg-gradient-to-r from-primary to-accent"></div>
                  <p className="text-3xl font-bold text-primary">9+</p>
                  <p className="text-xs text-gray-600 mt-1">{t.education.stats.technologies}</p>
                </div>
                <div className="relative">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-12 h-[2px] bg-gradient-to-r from-accent to-accent-light"></div>
                  <p className="text-3xl font-bold text-accent">15+</p>
                  <p className="text-xs text-gray-600 mt-1">{t.education.stats.projects}</p>
                </div>
                <div className="relative">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-12 h-[2px] bg-gradient-to-r from-accent-light to-primary"></div>
                  <p className="text-3xl font-bold text-primary">3+</p>
                  <p className="text-xs text-gray-600 mt-1">{t.education.stats.experience}</p>
                </div>
              </div>
            </div>
          </div>
